...
func main() {
	...
	flag.StringVar(&endpoint, "registration-path", "/controller.sock", "The socket path where the controller provides plugin registry.")
	flag.StringVar(&metricsAddr, "metrics-bind-address", ":8080", "The address the metric endpoint binds to.")
	flag.StringVar(&probeAddr, "health-probe-bind-address", ":8081", "The address the probe endpoint binds to.")
	flag.StringVar(&pluginName, "plugin-name", "kmra", "Name of the plugin to forward quote attestation request to.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "55c5974b.tac.intel.com",
	})
	if err != nil {
	...
	if err = controllers.NewQuoteAttestationReconciler(mgr.GetClient(), registry, mgr.GetScheme(), pluginName).SetupWithManager(mgr); err != nil {
